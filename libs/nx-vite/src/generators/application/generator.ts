...
//
// import { ViteBuildBuilderOptions } from '../../executors/build/executor';
...
// ): ProjectConfiguration {
//   const buildOptions: ViteBuildBuilderOptions = {
...
//     scripts: [],
//   };
//   const productionBuildOptions: Partial<ViteBuildBuilderOptions> = {
//     fileReplacements: [
//       {
...
//
//   const webTask = await viteInitGenerator(host, {
//     ...options,
//     skipFormat: true,
//   });
//   tasks.push(webTask);
